...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.ClienteModel", b =>
                {
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.FornecedorModel", b =>
                {
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.LojaModel", b =>
                {
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.PedidoModel", b =>
                {
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.PedidoProdutoModel", b =>
                {
                    b.Property<int>("PedidoId")
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.ProdutoModel", b =>
                {
                    b.Property<int>("ProdutoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.RepresentanteModel", b =>
                {
                    b.Property<int>("RepresentanteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.ClienteModel", b =>
                {
                    b.HasOne("Fiap.Api.Alunos.Models.RepresentanteModel", "Representante")
                        .WithMany()
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.PedidoModel", b =>
                {
                    b.HasOne("Fiap.Api.Alunos.Models.ClienteModel", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fiap.Api.Alunos.Models.LojaModel", "Loja")
                        .WithMany("Pedidos")
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.PedidoProdutoModel", b =>
                {
                    b.HasOne("Fiap.Api.Alunos.Models.PedidoModel", "Pedido")
                        .WithMany("PedidoProdutos")
                        .HasForeignKey("PedidoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fiap.Api.Alunos.Models.ProdutoModel", "Produto")
                        .WithMany("PedidoProdutos")
            ...
            modelBuilder.Entity("Fiap.Api.Alunos.Models.ProdutoModel", b =>
                {
                    b.HasOne("Fiap.Api.Alunos.Models.FornecedorModel", "Fornecedor")
                        .WithMany("Produtos")
